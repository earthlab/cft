#' Generate a climate scenario toolkit data frame
#'
#' @param file_reference A file reference data frame generated by `cstdata()`
#' @param cores Number of cores to use (int)
#' 
#' @return A tibble containing climate data averaged spatially over an area of interest.
#' 
#' @examples 
#' \dontrun{
#' file_ref <- cstdata(park = "Acadia National Park", parameters = "pr", 
