...
#' reference object generated by get_maca or get_gridmet. Averages represent all
#' grid cells within or touching the area of interest provided.
#'
#' @param file_reference A file reference data frame generated by `get_maca()`
...
#' @examples 
#' \dontrun{
#' file_ref <- get_maca(park = "Acadia National Park", 
#'                      parameters = "pr", 
#'                      years = c(2020, 2021), 
#'                      models = "CCSM4", 
#'                      scenarios = "rcp85")
