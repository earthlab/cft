...
([MACA v2](http://www.climatologylab.org/maca.html), & [GridMET](http://www.climatologylab.org/gridmet.html)) to support 
...
Then, download MACA data using the `cftdata()` function. 
