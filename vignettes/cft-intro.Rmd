...
the NPS. Use the `get_maca()` function to specify a range of years, a set of models,
...
# download data
file_refs <- get_maca(park = "Wind Cave National Park",
                      years = c(1980, 2040),
                      local_dir = proj_dir,
...
The output of `get_maca` is a data.frame, where each row corresponds to one file:
...
available argument options for the `get_maca()` function: `models`, `parameters`,
