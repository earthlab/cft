---
title: "Getting started with the Climate Scenarios Toolkit"
...
#> Observations: 160
#> Variables: 12
#> $ local_file     <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_1980_2040_daily.nc", "tasmin_wind_cave_nation…
#> $ local_path     <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_1980_20…
#> $ model          <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bc…
#> $ parameter      <chr> "tasmin", "tasmin", "tasmax", "tasmax", "uas", "uas", "vas", "vas", "tasmin", "tasmin", "tasmax", "tasmax", "uas", …
#> $ rcp            <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45"…
#> $ ensemble       <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1…
#> $ year1          <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1…
#> $ year2          <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2…
#> $ area_name      <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "wind_c…
#> $ units          <chr> "K", "K", "K", "K", "m s-1", "m s-1", "m s-1", "m s-1", "K", "K", "K", "K", "m s-1", "m s-1", "m s-1", "m s-1", "K"…
#> $ full_var_name  <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperature", "Maximum Temperature", "Eastward Wind", "Eastw…
#> $ parameter_long <chr> "air_temperature", "air_temperature", "air_temperature", "air_temperature", "eastward_wind", "eastward_wind", "nort…
```
...
#> Variables: 9
#> $ rcp       <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rc…
#> $ date      <date> 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01,…
#> $ model     <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1-m", "bcc-csm1-1-m", "BNU-ESM", "BNU-ESM", "CanESM2", "CanESM2", "CCSM4", "CCSM4"…
#> $ ensemble  <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r6i1p1", "r6i1p1", "r1i1p1", "r1i1p1", …
#> $ area_name <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "wind_cave_n…
#> $ tasmin    <dbl> 268.6157, 268.6157, 249.7267, 249.7267, 267.4672, 267.4672, 264.1932, 264.1932, 267.7191, 267.7191, 266.6899, 266.6899, …
#> $ tasmax    <dbl> 280.1809, 280.1809, 258.9463, 258.9463, 279.8731, 279.8731, 273.9576, 273.9576, 282.7115, 282.7115, 280.0450, 280.0450, …
#> $ uas       <dbl> 2.99698324, 2.99698324, -1.80401987, -1.80401987, 2.70510589, 2.70510589, 3.03666483, 3.03666483, 2.93035944, 2.93035944…
#> $ vas       <dbl> 1.7468967, 1.7468967, -1.8526285, -1.8526285, -1.8723701, -1.8723701, -0.3972101, -0.3972101, 2.7650571, 2.7650571, 3.57…
```
...
#>  2 rcp45 bcc-csm1-1  1981 r1i1p1             300
#>  3 rcp45 bcc-csm1-1  1982 r1i1p1             285
#>  4 rcp45 bcc-csm1-1  1983 r1i1p1             275
#>  5 rcp45 bcc-csm1-1  1984 r1i1p1             296
#>  6 rcp45 bcc-csm1-1  1985 r1i1p1             284
#>  7 rcp45 bcc-csm1-1  1986 r1i1p1             287
#>  8 rcp45 bcc-csm1-1  1987 r1i1p1             282
#>  9 rcp45 bcc-csm1-1  1988 r1i1p1             280
#> 10 rcp45 bcc-csm1-1  1989 r1i1p1             275
...
#> Calculating Reference Period Values
```
...
#> Observations: 80
#> Variables: 17
#> $ local_file        <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_1980_2040_daily.nc", "tasmin_wind_cave_nat…
#> $ local_path        <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_1980…
#> $ model             <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1-m", "bcc-csm1-1-m", "bcc-csm1-1-m", "bcc-csm…
#> $ parameter         <chr> "tasmin", "tasmin", "tasmax", "tasmax", "tasmin", "tasmin", "tasmax", "tasmax", "tasmin", "tasmin", "tasmax", "t…
#> $ rcp               <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp…
#> $ ensemble          <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r…
#> $ year1             <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980…
#> $ year2             <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040…
#> $ area_name         <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park", "win…
#> $ units             <chr> "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C…
#> $ full_var_name     <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperature", "Maximum Temperature", "Minimum Temperature…
#> $ parameter_long    <chr> "air_temperature", "air_temperature", "air_temperature", "air_temperature", "air_temperature", "air_temperature"…
#> $ months            <list> [<"May", "Jun", "Jul", "Aug">, <"May", "Jun", "Jul", "Aug">, <"May", "Jun", "Jul", "Aug">, <"May", "Jun", "Jul"…
#> $ target_summary    <dbl> 11.94054, 12.57719, 28.21358, 28.98764, 11.97506, 12.17570, 28.28937, 28.67193, 12.59145, 12.63916, 28.09927, 27…
#> $ reference_summary <dbl> 10.98311, 10.98311, 26.88557, 26.88557, 10.83418, 10.83418, 26.50948, 26.50948, 11.11244, 11.11244, 26.63762, 26…
#> $ diff_summary      <dbl> 0.95742747, 1.59407772, 1.32801461, 2.10207361, 1.14088709, 1.34152643, 1.77988983, 2.16244323, 1.47901370, 1.52…
#> $ label             <chr> "Difference in Minimum Temperature (C)", "Difference in Minimum Temperature (C)", "Difference in Maximum Tempera…
```
...
```r
comps %>%
  select(parameter, rcp, model, year1, year2, diff_summary) %>%
...
```r
references$models
#>  [1] "bcc-csm1-1"     "bcc-csm1-1-m"   "BNU-ESM"        "CanESM2"        "CCSM4"          "CNRM-CM5"       "CSIRO-Mk3-6-0"  "GFDL-ESM2M"    
#>  [9] "GFDL-ESM2G"     "HadGEM2-ES365"  "HadGEM2-CC365"  "inmcm4"         "IPSL-CM5A-LR"   "IPSL-CM5A-MR"   "IPSL-CM5B-LR"   "MIROC5"        
