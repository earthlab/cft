...
#> $ full_varname     <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperat…
#> $ internal_varname <chr> "air_temperature", "air_temperature", "air_temperature", "air_t…
...
#> $ date      <date> 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-0…
...
#> $ area_name <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_natio…
#> $ tasmin    <dbl> 268.6556, 268.6556, 249.5089, 249.5089, 267.4565, 267.4565, 264.1158, …
#> $ tasmax    <dbl> 280.0941, 280.0941, 258.7186, 258.7186, 279.6128, 279.6128, 273.8713, …
#> $ uas       <dbl> 3.0490896, 3.0490896, -1.6518571, -1.6518571, 2.6976433, 2.6976433, 2.…
#> $ vas       <dbl> 1.4561018, 1.4561018, -1.7092865, -1.7092865, -2.1272987, -2.1272987, …
```
...
#> Variables: 7
#> Groups: rcp [2]
#> $ model           <chr> "bcc-csm1-1", "bcc-csm1-1-m", "BNU-ESM", "CanESM2", "CCSM4", "CN…
#> $ rcp             <chr> "rcp45", "rcp45", "rcp45", "rcp45", "rcp45", "rcp45", "rcp45", "…
#> $ variable        <chr> "tasmin", "tasmin", "tasmin", "tasmin", "tasmin", "tasmin", "tas…
#> $ units           <chr> "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K",…
#> $ value_reference <dbl> 284.0221, 283.8716, 284.1512, 283.6515, 283.9051, 283.6558, 283.…
#> $ value_target    <dbl> 284.9774, 285.0160, 285.6242, 286.2288, 285.4229, 285.4266, 285.…
#> $ difference      <dbl> 0.9553126, 1.1443937, 1.4730053, 2.5772584, 1.5177512, 1.7707875…
```
