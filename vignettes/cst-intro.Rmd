...
#> $ vas       <dbl> 1.4561018, 1.4561018, -1.7092865, -1.7092865, -2.1272987, -2.1272987, -0.6530413, -0.6530413, 2…
```
...
#> $ label             <chr> "Difference in Minimum Temperature (C)", "Difference in Minimum Temperature (C)", "Diff…
```
