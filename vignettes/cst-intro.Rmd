...
#> Observations: 160
#> Variables: 12
#> $ local_file     <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2m…
#> $ local_path     <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_nationa…
#> $ model          <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-cs…
#> $ parameter      <chr> "tasmin", "tasmin", "tasmax", "tasmax", "uas", "uas", "vas", "v…
#> $ rcp            <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", …
#> $ ensemble       <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1…
#> $ year1          <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 198…
#> $ year2          <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 204…
#> $ area_name      <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cav…
#> $ units          <chr> "K", "K", "K", "K", "m s-1", "m s-1", "m s-1", "m s-1", "K", "K…
#> $ full_var_name  <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperat…
#> $ parameter_long <chr> "air_temperature", "air_temperature", "air_temperature", "air_t…
```
...
#> Variables: 9
#> $ rcp       <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp8…
#> $ date      <date> 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01…
#> $ model     <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1-m", "bcc-csm1-1-m", "BNU-ESM…
#> $ ensemble  <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1"…
#> $ area_name <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_nat…
#> $ tasmin    <dbl> 268.6157, 268.6157, 249.7267, 249.7267, 267.4672, 267.4672, 264.1932…
#> $ tasmax    <dbl> 280.1809, 280.1809, 258.9463, 258.9463, 279.8731, 279.8731, 273.9576…
#> $ uas       <dbl> 2.99698324, 2.99698324, -1.80401987, -1.80401987, 2.70510589, 2.7051…
#> $ vas       <dbl> 1.7468967, 1.7468967, -1.8526285, -1.8526285, -1.8723701, -1.8723701…
```
...
#> Observations: 80
#> Variables: 17
#> $ local_file        <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_maca…
#> $ local_path        <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_nati…
#> $ model             <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc…
#> $ parameter         <chr> "tasmin", "tasmin", "tasmax", "tasmax", "tasmin", "tasmin", …
#> $ rcp               <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45…
#> $ ensemble          <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", …
#> $ year1             <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, …
#> $ year2             <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, …
#> $ area_name         <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_…
#> $ units             <chr> "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", …
#> $ full_var_name     <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Tempe…
#> $ parameter_long    <chr> "air_temperature", "air_temperature", "air_temperature", "ai…
#> $ months            <list> [<"May", "Jun", "Jul", "Aug">, <"May", "Jun", "Jul", "Aug">…
#> $ target_summary    <dbl> 11.94054, 12.57719, 28.21358, 28.98764, 11.97506, 12.17570, …
#> $ reference_summary <dbl> 10.98311, 10.98311, 26.88557, 26.88557, 10.83418, 10.83418, …
#> $ diff_summary      <dbl> 0.9574275, 1.5940777, 1.3280146, 2.1020736, 1.1408871, 1.341…
#> $ label             <chr> "Difference in Minimum Temperature (C)", "Difference in Mini…
```
...
#>  [1] "tasmin" "tasmax" "rhsmin" "rhsmax" "pr"     "rsds"   "uas"    "vas"    "huss"  
#> [10] "vpd"
```
