...
#> Observations: 160
#> Variables: 12
#> $ local_file     <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_1980_…
#> $ local_path     <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_national_park_bcc-c…
#> $ model          <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-…
#> $ parameter      <chr> "tasmin", "tasmin", "tasmax", "tasmax", "uas", "uas", "vas", "vas", "tasmin…
#> $ rcp            <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rc…
#> $ ensemble       <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1…
#> $ year1          <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 198…
#> $ year2          <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 204…
#> $ area_name      <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_p…
#> $ units          <chr> "K", "K", "K", "K", "m s-1", "m s-1", "m s-1", "m s-1", "K", "K", "K", "K",…
#> $ full_var_name  <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperature", "Maxim…
#> $ parameter_long <chr> "air_temperature", "air_temperature", "air_temperature", "air_temperature",…
```
...
#> Variables: 9
#> $ rcp       <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45",…
#> $ date      <date> 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01-01, 1980-01…
#> $ model     <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1-m", "bcc-csm1-1-m", "BNU-ESM", "BNU-ESM"…
#> $ ensemble  <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", …
#> $ area_name <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_national_park",…
#> $ tasmin    <dbl> 268.6157, 268.6157, 249.7267, 249.7267, 267.4672, 267.4672, 264.1932, 264.1932, …
#> $ tasmax    <dbl> 280.1809, 280.1809, 258.9463, 258.9463, 279.8731, 279.8731, 273.9576, 273.9576, …
#> $ uas       <dbl> 2.99698324, 2.99698324, -1.80401987, -1.80401987, 2.70510589, 2.70510589, 3.0366…
#> $ vas       <dbl> 1.7468967, 1.7468967, -1.8526285, -1.8526285, -1.8723701, -1.8723701, -0.3972101…
```
...
#> Observations: 80
#> Variables: 17
#> $ local_file        <chr> "tasmin_wind_cave_national_park_bcc-csm1-1_r1i1p1_rcp45_macav2metdata_19…
#> $ local_path        <chr> "/home/mjoseph/wind_cave_national_park/tasmin_wind_cave_national_park_bc…
#> $ model             <chr> "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1", "bcc-csm1-1-m", …
#> $ parameter         <chr> "tasmin", "tasmin", "tasmax", "tasmax", "tasmin", "tasmin", "tasmax", "t…
#> $ rcp               <chr> "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", "rcp45", "rcp85", …
#> $ ensemble          <chr> "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r1i1p1", "r…
#> $ year1             <dbl> 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, 1980, …
#> $ year2             <dbl> 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, 2040, …
#> $ area_name         <chr> "wind_cave_national_park", "wind_cave_national_park", "wind_cave_nationa…
#> $ units             <chr> "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C", "C…
#> $ full_var_name     <chr> "Minimum Temperature", "Minimum Temperature", "Maximum Temperature", "Ma…
#> $ parameter_long    <chr> "air_temperature", "air_temperature", "air_temperature", "air_temperatur…
#> $ months            <list> [<"May", "Jun", "Jul", "Aug">, <"May", "Jun", "Jul", "Aug">, <"May", "J…
#> $ target_summary    <dbl> 11.94054, 12.57719, 28.21358, 28.98764, 11.97506, 12.17570, 28.28937, 28…
#> $ reference_summary <dbl> 10.98311, 10.98311, 26.88557, 26.88557, 10.83418, 10.83418, 26.50948, 26…
#> $ diff_summary      <dbl> 0.9574275, 1.5940777, 1.3280146, 2.1020736, 1.1408871, 1.3415264, 1.7798…
#> $ label             <chr> "Difference in Minimum Temperature (C)", "Difference in Minimum Temperat…
```
...
```r
references$models
#>  [1] "bcc-csm1-1"     "bcc-csm1-1-m"   "BNU-ESM"        "CanESM2"        "CCSM4"         
#>  [6] "CNRM-CM5"       "CSIRO-Mk3-6-0"  "GFDL-ESM2M"     "GFDL-ESM2G"     "HadGEM2-ES365" 
#> [11] "HadGEM2-CC365"  "inmcm4"         "IPSL-CM5A-LR"   "IPSL-CM5A-MR"   "IPSL-CM5B-LR"  
#> [16] "MIROC5"         "MIROC-ESM"      "MIROC-ESM-CHEM" "MRI-CGCM3"      "NorESM1-M"
```
